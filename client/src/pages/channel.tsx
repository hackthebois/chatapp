...
import { chatChannelRoute, chatRoute } from "../router";
...
const Channel = () => {
	const { channelId } = useParams({ from: chatChannelRoute.id });
	...
	return (
		<div className="flex flex-1 flex-col justify-end overflow-y-auto p-4 sm:p-8 sm:pt-4">
